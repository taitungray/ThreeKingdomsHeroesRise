...
> **核心指導文件**：
> - 視覺聖經：[`docs/game-art-bible.md`](file:///d:/Rayon/ThreeKingdomsHeroesRise/docs/game-art-bible.md)
> - 角色圖片化方案：[`docs/combat-character-sprite-migration.md`](file:///d:/Rayon/ThreeKingdomsHeroesRise/docs/combat-character-sprite-migration.md)
> - 全局 UI 與裝備評估：[`docs/global-ui-and-icon-art-evaluation.md`](file:///d:/Rayon/ThreeKingdomsHeroesRise/docs/global-ui-and-icon-art-evaluation.md)
> - 戰鬥表現與打擊感：[`docs/combat-visual-enhancement-plan.md`](file:///d:/Rayon/ThreeKingdomsHeroesRise/docs/combat-visual-enhancement-plan.md)
> - 商業化與內購支付：[`docs/payment-and-iap-plan.md`](file:///d:/Rayon/ThreeKingdomsHeroesRise/docs/payment-and-iap-plan.md)
...
- [ ] **3.1 拆件式像素素材系統 (Modular Sprites Engine)**：
...
- [ ] **4.3 商業化與內購支付（IAP）**：
  - 建立本地商城介面（`data/shop-data.js`）。
  - 接入 `@revenuecat/purchases-capacitor`，實作「永久去廣告卡」、「超值月卡」與「首充神將禮包」。
