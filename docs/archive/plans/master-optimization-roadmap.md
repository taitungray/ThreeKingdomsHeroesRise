...
> **ARCHIVED PLAN — 2026-08-27。** 其中 `[x]` 只表示當時曾實作或宣告，不是目前完成證明。現況、問題與工作分別見 [目前遊戲規格](../../specs/current-game-spec.md)、[已知問題](../../issues/known-issues.md) 與 [目前工作清單](../../work/active-backlog.md)。

> **建立日期**：2026-08-27  
> **目標**：將專案從「純代碼繪製的原型 Demo」全方位升級為「商業級精品國風像素三國放置 RPG」。  
> **核心指導文件**：
> - 現行視覺規範：[遊戲美術規範](../../standards/game-art-bible.md)
> - 歷史角色圖片化評估：[Sprite 遷移評估](../evaluations/combat-character-sprite-migration.md)
> - 歷史 UI 與裝備評估：[全局 UI 與圖示評估](../evaluations/global-ui-and-icon-art-evaluation.md)
> - 歷史戰鬥表現計畫：[戰鬥視覺強化](combat-visual-enhancement-plan.md)
> - 歷史商業化計畫：[IAP 技術方案](payment-and-iap-plan.md)
...
- 其餘需外部帳號、金鑰或正式資產的項目目前列於 [目前工作清單](../../work/active-backlog.md)。
