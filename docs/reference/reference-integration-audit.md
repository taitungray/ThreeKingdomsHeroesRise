...
狀態：REFERENCE AUDIT。記錄 2026-08-28 的一次性比較結果；目前文件架構以 [文件入口](../README.md) 為準。
...
| 方法 | 落地位置 |
|---|---|
| 權威現況、工作、問題、QA 與歷史分層 | `docs/README.md`、`AGENTS.md` |
| `已確認／推論／缺少證據／不一致` 證據標籤 | `standards/production-rules.md`、`specs/current-game-spec.md` |
| 依風險決定快速或完整驗證 | `standards/production-rules.md`、`qa/qa-test-matrix.md` |
| 功能 QA 與視覺 QA 分開 | `qa/qa-test-matrix.md`、`qa/visual-qa.md` |
| Given／When／Then、背景恢復、重啟與 storage 邊界 | `qa/qa-test-matrix.md` |
| 完成宣告需附命令、環境、結果與未測範圍 | `standards/production-rules.md` |
| 實際問題與行動清單分開 | `issues/known-issues.md`、`work/active-backlog.md` |
| selector／變數／識別字使用 ASCII | `standards/production-rules.md` |
