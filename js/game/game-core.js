...
const HERO_BATTLE_QUOTES = {
  ...
  pangtong: ["鳳雛展翼，火攻奇謀！", "智計百出，決勝帷幄！"],
  weiyan: ["反骨何妨，唯戰而已！", "陷陣衝鋒，萬軍難當！"],
  jiangwei: ["繼承丞相遺志，九伐中原！", "心存漢室，死戰不休！"],
  guanping: ["承父威名，刀鋒無畏！", "忠烈之嗣，誓斬敵酋！"],
  guanxing: ["青龍繼武，斬敵先鋒！", "不辱父名，披荊斬棘！"],
  fazheng: ["料敵如神，漢中必克！", "奇謀助主，算無漏算！"],

  // 曹魏 (13名)
  caocao: ["寧教我負天下人，休教天下人負我！", "唯才是舉，天下歸魏！"],
  xiahoudun: ["父母精血，不可棄也！", "獨眼何懼，拔矢再戰！"],
  dianwei: ["古之惡來，雙戟護主！", "死守營門，一步不退！"],
  xuhuang: ["治軍嚴整，有周亞夫之風！", "開山大斧，破陣先驅！"],
  zhangliao: ["威震逍遙津，江東小兒不敢夜啼！", "奔襲千軍，直取中軍！"],
  zhanghe: ["用兵巧變，善列營陣！", "巧變之將，料敵機先！"],
  xunyu: ["王佐之才，定鼎中原！", "驅虎吞狼，漢室匡弼！"],
  guojia: ["算無遺策，主公速決！", "兵貴神速，破敵正當此時！"],
  yujin: ["法度森嚴，治軍如鐵！", "毅重持節，嚴陣以待！"],
  lejin: ["先登陷陣，每戰必前！", "驍勇果決，破敵奪旗！"],
  caoren: ["鐵壁曹仁，堅不可摧！", "固若金湯，固守待變！"],
  xiahouyuan: ["虎步關右，三日五百！", "神速出奇，直插敵後！"],
  yuanshao: ["四世三公，號令天下諸侯！", "河北盟主，揮師南下！"],

  // 東吳 (13名)
  sunshang: ["巾幗何曾讓鬚眉，吃我一箭！", "梟姬弓滿，烈焰焚敵！"],
  zhouyu: ["談笑間，檣櫓灰飛煙滅！", "赤壁烈火，燃盡千艘戰船！"],
  lusu: ["榻上之策，鼎足三分！", "大智若愚，寬仁宏量！"],
  luxun: ["火燒連營七百里！", "大器晚成，後生可畏！"],
  ganning: ["錦帆甘興霸，百騎劫魏營！", "鈴響之處，片甲不留！"],
  taishici: ["大丈夫生於亂世，當帶三尺劍立不世之功！", "酣戰一場，不負平生！"],
  zhuran: ["江東名將，臨危受命！", "水戰陸攻，皆不在話下！"],
  panzhang: ["擒關羽奪青龍，戰功赫赫！", "誘敵深入，一網打盡！"],
  huanggai: ["苦肉計成，火燒赤壁！", "老將披甲，赤膽忠心！"],
  handang: ["江東老將，歷事三世！", "矢石無避，衝鋒陷陣！"],
  chengpu: ["程公在此，誰敢放肆！", "三朝元老，穩坐中軍！"],
  daqiao: ["願得一人心，白首不相離。", "琴音化刃，護我江東。"],
  xiaoqiao: ["東風不與周郎便，銅雀春深鎖二喬。", "輕舞飛揚，助夫破敵。"],
  ...
  zhangbao: ["地公將軍，雷霆化形！", "黃天當立，歲在甲子！"],
  zhangliang: ["人公將軍，符水度人！", "太平道法，無量神通！"],
  menghuo: ["南中蠻王，七擒亦不服！", "萬獸咆哮，踏碎敵陣！"],
  zhurong: ["祝融火神，烈刃飛刀！", "南蠻巾幗，誰與爭鋒！"],
  madai: ["斬魏延受丞相遺命！", "西涼鐵騎，勇冠三軍！"],
  gongsunzan: ["白馬義從，威震塞外！", "義之所至，生死相隨！"],
  zhenji: ["髣髴兮若輕雲之蔽月，飄颻兮若流風之回雪。", "洛神凌波，悲愴動人。"],
  dongzhuo: ["順我者昌，逆我者亡！", "西涼鐵騎，踏平洛陽！"],
  zhangjiao: ["蒼天已死，黃天當立！", "雷公助我，天下大吉！"],
  yanliang: ["河北名將顏良，誰敢搦戰！", "力拔山兮，刀斬敵首！"],
  wenchou: ["河北文醜，鐵騎所向披靡！", "橫槊長驅，誰與爭鋒！"]
};
